    ...
    <section className="relative py-24 md:py-32 px-4" style={{ background: 'linear-gradient(180deg, transparent, rgba(255,0,255,0.03), transparent)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="glass-glow rounded-2xl p-8 md:p-12 text-center mb-12 relative overflow-hidden">
          ...
          <p className="relative font-mono text-5xl md:text-7xl text-white mb-2" style={{ textShadow: '0 0 40px rgba(255,0,255,0.4)' }}>
            {config.fundingAsk}
          </p>
          ...
          <div className="relative flex flex-wrap justify-center gap-4 text-xs">
            ...
            <span className="px-3 py-1 rounded-full bg-[#00f0ff]/10 border border-[#00f0ff]/30 text-[#00f0ff]">Equity: {config.equityOffered}</span>
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {config.projectedRevenue.map((rev) => (
              <div key={rev.year} className="rounded-xl p-5 border border-[#ff00ff]/20 bg-[#ff00ff]/5">
